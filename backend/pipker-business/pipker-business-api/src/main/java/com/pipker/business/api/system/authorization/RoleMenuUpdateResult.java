 ...
 * @logic Gives the client a stable save confirmation without exposing unrelated roles or API permission data.
 ...
 * 角色页面菜单保存结果。
 */
public record RoleMenuUpdateResult(Long roleId, List<Long> menuIds) {
}
